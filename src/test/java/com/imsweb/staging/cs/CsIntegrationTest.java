...
public class CsIntegrationTest {
    ...
    private static final List<String> _SCHEMA_FILES = null;
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // get the complete list of files and sort by name
        ...
        for (File f : files) {
            if (f.isFile() && f.getName().endsWith(".gz")) {
                if (_SCHEMA_FILES == null || _SCHEMA_FILES.contains(f.getName())) {
                    totalFiles += 1;
