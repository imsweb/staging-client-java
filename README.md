...
[![CircleCI](https://circleci.com/gh/imsweb/staging-client-java.svg?style=svg)](https://circleci.com/gh/imsweb/staging-client-java)
...
```groovy
compile 'com.imsweb.com:staging-client-java:4.5'
```
