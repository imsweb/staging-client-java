...
|---------------|------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
| 1.3           | [11.7.0](https://github.com/imsweb/staging-client-java/releases/tag/v11.7.0) | [pediatric-1.3.zip](https://github.com/imsweb/staging-client-java/releases/download/v11.7.0/pediatric-1.3.zip) |
...
| Version | Release                                                                      | Algorithm ZIP                                                                                                    |
|---------|------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|
| 3.3     | [11.7.0](https://github.com/imsweb/staging-client-java/releases/tag/v11.7.0) | [eod_public-3.3.zip](https://github.com/imsweb/staging-client-java/releases/download/v11.7.0/eod_public-3.3.zip) |
